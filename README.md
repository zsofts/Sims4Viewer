...
• 👗 Instant 3D CAS & Build/Buy Viewport: full rendering of clothing, hair, footwear, accessories, tattoos, makeup and furniture on interactive mannequins with all swatches and LOD levels.

• 🧊 Advanced PBR Shaders: full support for Diffuse, Normal Maps, Specular Maps, Shadow Maps, and Emission with Smart Auto UV Shift Fix.

• 🕺 Poses, Presets & Sliders: interactive body/face preset viewer and live CAS slider testing.

• 📦 Merged Package Inspector & Packer: deep inspection of nested sub-mods inside merged .package files, with bulk merge and unpack tools.
...
4. 🗂️ MOD MANAGEMENT & FILE ORGANIZATION
 
   • Directory tree with lightning-fast navigation and global search by title, creator, or filename.
   
   • 1-Click Enable / Disable: safely disable CC by toggling the extension for single files or entire folders.
...
6. 📦 MERGED PACKAGE INSPECTOR & BULK MERGE ENGINE
   ...
   • Deep Merged Package Inspection: unpacks and displays all nested sub-mods inside huge merged .package files individually with their own 3D previews and swatches.
...
8. 🎨 VISUAL THEMES & INTERNATIONALIZATION
   ...
   • 10 built-in modern themes + full visual theme builder with custom accent colors.
   
   • Power-user keyboard shortcuts for lightning-fast workflows.
...
• RAM: 4 GB (Rec: 8–16 GB for 10,000+ CC libraries)

• GPU: WebGL 2.0 / DirectX 11 support (Rec: Dedicated 2 GB+ VRAM)

• Storage: ~500 MB (SSD recommended for instant indexing)
